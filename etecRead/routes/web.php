...
Route::middleware(['auth'])->group(function () {
    ...
    //Perfil
    Route::get('/perfil', [\App\Http\Controllers\Web\ProfileController::class, 'show'])->name('perfil.show');
    Route::put('/perfil', [\App\Http\Controllers\Web\ProfileController::class, 'update'])->name('perfil.update');
    ...
    // Criar reserva
    Route::post('/reservas', [\App\Http\Controllers\Web\ReservationWebController::class, 'store'])->name('reservas.store');
