        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1">
                <div class="rounded-lg shadow-xl overflow-hidden">
                    ...
                    @else
                        <div class="bg-gradient-to-br from-blue-400 to-purple-500 p-12 flex items-center justify-center h-96">
                ...
                <div class="mt-6 bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span
                                class="font-semibold text-orange-600">{{ $livro->total_quantity - $livro->available_quantity }}
                                unidades</span>
                        </div>
                    </div>
                    ...
                    <div class="mt-6">
                        @if($livro->available_quantity > 0)
                            <div class="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                                ...
                                <p class="text-green-600 text-sm mt-1">Procure a bibliotecária para emprestar</p>
                            </div>
                        @else
                            <div class="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
                                ...
                                @if(auth()->check() && auth()->user()->role === 'aluno')
                                    ...
                                    @else
                                        <p class="text-red-600 text-sm mt-2 mb-3">Faça uma reserva para ser avisado quando estiver
                                            disponível</p>

                                        <form method="POST" action="{{ route('reservas.store') }}" class="mt-3">
                                            @csrf
                                    ...
                                    @endif
                                @else
                                    <p class="text-red-600 text-sm mt-2">Faça login como aluno para reservar</p>
                                @endif
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-lg p-8">
                        ...
                        <div class="mb-6">
                            ...
                            <p class="text-gray-600 leading-relaxed">
                                Este livro faz parte do acervo da biblioteca escolar e está disponível para empréstimo aos
                                alunos.
                                O prazo padrão de empréstimo é de 14 dias, podendo ser renovado caso não haja reservas
                                pendentes.
                            </p>
                        </div>
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
                            ...
                            <ul class="space-y-2 text-blue-700 text-sm">
                                ...
                                @if($livro->available_quantity == 0)
                                    <li class="flex items-start">
                                        <span class="mr-2">•</span>
                                        <span>Você pode fazer uma reserva para ser avisado quando o livro estiver
                                            disponível</span>
                                    </li>
                                @endif
                            </ul>
