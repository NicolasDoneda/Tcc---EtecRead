        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            <form method="GET" action="{{ route('livros.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Digite o nome do livro..."
            ...
            <div class="mt-4 flex items-center">
                <label class="flex items-center cursor-pointer">
                    <input type="checkbox"
                        ...
                        {{ request('disponivel') ? 'checked' : '' }} class="mr-2 h-4 w-4 text-blue-600">
                ...
                @foreach($livros as $livro)
                    <a href="{{ route('livros.show', $livro->id) }}"
                        ...
                        <div class="h-48 flex items-center justify-center overflow-hidden">
                            ...
                            @else
                                <div
                                    class="bg-gradient-to-br from-blue-400 to-purple-500 w-full h-full flex items-center justify-center">
