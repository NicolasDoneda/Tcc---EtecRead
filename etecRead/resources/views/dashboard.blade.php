        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <a href="{{ route('livros.show', $livro->id) }}" 
                   class="border border-gray-200 rounded-lg p-3 hover:shadow-md hover:border-blue-300 transition">
                    <div class="bg-blue-100 rounded h-32 flex items-center justify-center mb-2">
