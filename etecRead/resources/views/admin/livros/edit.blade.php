        ...
        <form method="POST" action="{{ route('admin.livros.update', $livro->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <div class="flex items-start gap-6">
                    <div class="flex-shrink-0">
                        <div id="preview-container" class="w-48 h-64 bg-gradient-to-br from-blue-400 to-purple-500 rounded-lg flex items-center justify-center overflow-hidden">
                            @if($livro->cover_image)
                                <img id="image-preview" src="{{ asset('storage/' . $livro->cover_image) }}" alt="Capa" class="w-full h-full object-cover">
                                <svg id="default-icon" class="w-24 h-24 text-white hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                </svg>
                            @else
                                <svg id="default-icon" class="w-24 h-24 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                                </svg>
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 mt-2">Deixe em branco para manter a imagem atual</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="year" value="{{ old('year', $livro->year) }}" 
                           min="1000" max="{{ date('Y') }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="total_quantity" value="{{ old('total_quantity', $livro->total_quantity) }}" 
                           min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="available_quantity" value="{{ old('available_quantity', $livro->available_quantity) }}" 
                           min="0"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none" 
                           required>
