                    ...
                    <div class="flex items-start gap-6">
                        <div class="flex-shrink-0">
                            <div id="preview-container"
                                ...
                                @if($usuario->photo)
                                    <img id="image-preview" src="{{ asset('storage/' . $usuario->photo) }}" alt="Foto"
                                        class="w-full h-full object-cover">
                                    <svg id="default-icon" class="w-16 h-16 text-white hidden" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="role" id="role"
                            ...
                            <option value="aluno" {{ old('role', $usuario->role) == 'aluno' ? 'selected' : '' }}>Aluno
                            </option>
                            <option value="admin" {{ old('role', $usuario->role) == 'admin' ? 'selected' : '' }}>Administrador
                            </option>
                        </select>
                    </div>
                    ...
                    <div id="ano-escolar-field">
                        ...
                        <select name="ano_escolar"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            <option value="">Selecione...</option>
                            <option value="1" {{ old('ano_escolar', $usuario->ano_escolar) == '1' ? 'selected' : '' }}>1º ano
                            </option>
                            <option value="2" {{ old('ano_escolar', $usuario->ano_escolar) == '2' ? 'selected' : '' }}>2º ano
                            </option>
                            <option value="3" {{ old('ano_escolar', $usuario->ano_escolar) == '3' ? 'selected' : '' }}>3º ano
                            </option>
                        </select>
                    </div>
                </div>
