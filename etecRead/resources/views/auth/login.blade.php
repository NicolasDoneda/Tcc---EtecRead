...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-500 to-purple-600">
    <div class="bg-white p-8 rounded-lg shadow-2xl w-full max-w-md">
        ...
        <form method="POST" action="{{ route('login.post') }}">
            ...
            <button type="submit" class="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 font-semibold transition">
                Entrar
            </button>
        </form>
        ...
        <div class="mt-6 text-center">
            <p class="text-gray-600">
                Não tem conta? 
                <a href="{{ route('register') }}" class="text-blue-600 hover:underline font-semibold">Registre-se aqui</a>
            </p>
        </div>
    </div>
</div>
